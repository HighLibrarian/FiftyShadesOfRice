...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("/home/bdw/.config/waybar/scripts/launch.sh"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("obsidian"))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("/home/bdw/.config/hypr/scripts/start-edge.sh"))
